  ...
  return (
    <main id="top">
      ...
      <section className="hero shell">
        ...
        <div className="robotStage" aria-label="Interactive 3D humanoid robot">
          <div className="robotBackText">CODEARC</div>
          <iframe
            title="CodeArc Labs interactive robot"
            src="https://sketchfab.com/models/9286a1f22d0248f2b2c67dd8e655f1d0/embed?autostart=1&ui_infos=0&ui_controls=0&ui_stop=0&ui_watermark=0&ui_watermark_link=0&transparent=1"
            allow="autoplay; fullscreen; xr-spatial-tracking"
            allowFullScreen
          />
          <div className="robotBadge">INTERACTIVE 3D</div>
        </div>
      </section>
      ...
      <section className="statement dark" id="studio">
        <div className="shell statementGrid">
          ...
          <div className="statementCard gradientC"><span>03</span><strong>Depth where useful</strong><p>One hero robot, then graphic gradients and product-first layouts.</p></div>
        </div>
      </section>
